...
class CPU {
 private:
  ...
  void LD_aHL_C_Instruction(Memory* mem);
  void LD_aHL_D_Instruction(Memory* mem);
  void LD_aHL_E_Instruction(Memory* mem);
  ...
  void DEC_E_Instruction(Memory* mem);
  void DEC_L_Instruction(Memory* mem);
  ...
  void LD_H_D_Instruction(Memory* mem);
  void LD_H_d8_Instruction(Memory* mem);
  void LD_L_A_Instruction(Memory* mem);
  void LD_L_C_Instruction(Memory* mem);
  void LD_L_E_Instruction(Memory* mem);
  ...
  void LD_E_L_Instruction(Memory* mem);
  ...
  void ADC_A_C_Instruction(Memory* mem);
  void SUB_A_B_Instruction(Memory* mem);
  void SUB_A_d8_Instruction(Memory* mem);
  void SUB_A_aHL_Instruction(Memory* mem);
  void SBC_A_C_Instruction(Memory* mem);
  void SBC_A_d8_Instruction(Memory* mem);
  ...
  void OR_A_d8_Instruction(Memory* mem);
