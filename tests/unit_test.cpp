...
TEST(Instructions, LD_E_d8_instruction) {
  ...
  int to_load = 0x50;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_E_d8);
  game.mem.SetInAddr(0x101, to_load);
...
TEST(Instructions, CP_A_aHL_instruction_true_case) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, CP_A_aHL);
...
TEST(Instructions, LD_A_aBC_instruction) {
  ...
  game.mem.SetInAddr(0x100, LD_A_aBC);
...
TEST(Instructions, LD_aHL_C_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_aHL_C);
  game.mem.SetInAddr(0x150, 0x0);
  game.cpu.reg.C = 0x15;
  game.cpu.reg.H = 0x01;
  game.cpu.reg.L = 0x50;
  ...
  EXPECT_EQ(game.mem.GetInAddr(0x0150), 0x15);
  EXPECT_EQ(game.cpu.reg.PC, 0x101);
}
...
TEST(Instructions, LD_aHL_D_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_aHL_D);
  game.mem.SetInAddr(0x150, 0x0);
  game.cpu.reg.D = 0x10;
  game.cpu.reg.H = 0x01;
  game.cpu.reg.L = 0x50;
...
TEST(Instructions, LD_aHL_E_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_aHL_E);
  game.mem.SetInAddr(0x150, 0x0);
  game.cpu.reg.E = 0x10;
  game.cpu.reg.H = 0x01;
  game.cpu.reg.L = 0x50;
...
TEST(Instructions, LD_aDE_A_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_aDE_A);
  game.mem.SetInAddr(0x150, 0x0);
  game.cpu.reg.A = 0x10;
  game.cpu.reg.D = 0x01;
  game.cpu.reg.E = 0x50;
...
TEST(Instructions, LD_A_D_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_A_D);
  game.cpu.reg.A = 0x00;
  game.cpu.reg.D = 0x01;
...
TEST(Instructions, LD_A_E_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_A_E);
  game.cpu.reg.A = 0x00;
  game.cpu.reg.E = 0x01;
...
TEST(Instructions, LD_E_A_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_E_A);
  game.cpu.reg.E = 0x00;
  game.cpu.reg.A = 0x01;
...
TEST(Instructions, LD_E_L_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_E_L);
  game.cpu.reg.E = 0x00;
  game.cpu.reg.L = 0x01;
...
TEST(Instructions, LD_H_B_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_H_B);
  game.cpu.reg.B = 0x01;
  game.cpu.reg.H = 0x00;
...
TEST(Instructions, LD_H_D_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_H_D);
  game.cpu.reg.H = 0x00;
  game.cpu.reg.D = 0x01;
...
TEST(Instructions, LD_H_d8_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_H_d8);
  game.mem.SetInAddr(0x101, 0x01);
  game.cpu.reg.H = 0x00;
...
TEST(Instructions, LD_L_C_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_L_C);
  game.cpu.reg.C = 0x01;
  game.cpu.reg.L = 0x00;
...
TEST(Instructions, LD_L_E_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_L_E);
  game.cpu.reg.E = 0x01;
  game.cpu.reg.L = 0x00;
...
TEST(Instructions, LD_C_aHL_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_C_aHL);
  game.mem.SetInAddr(0x150, 0x50);
  game.cpu.reg.C = 0x00;
  game.cpu.reg.H = 0x01;
  game.cpu.reg.L = 0x50;
...
TEST(Instructions, LD_D_aHL_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_D_aHL);
  game.mem.SetInAddr(0x150, 0x50);
  game.cpu.reg.D = 0x00;
  game.cpu.reg.H = 0x01;
  game.cpu.reg.L = 0x50;
...
TEST(Instructions, LD_E_aHL_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_E_aHL);
  game.mem.SetInAddr(0x150, 0x50);
  game.cpu.reg.E = 0x00;
  game.cpu.reg.H = 0x01;
  game.cpu.reg.L = 0x50;
...
TEST(Instructions, JR_C_s8_instruction_carry_not_set) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, JR_C_s8);
  game.mem.SetInAddr(0x101, 0x8);
  game.cpu.reg.F = 0x0;
