...
TEST(Instructions, LD_A_a8_instruction) {
  ...
  Address address_to_store = 0x150;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_A_a8);
  game.mem.SetInAddr(0x101, 0xfe);
...
TEST(Instructions, PUSH_AF_instruction) {
  ...
  game.initialize_registers();
  Address sp_old_position = game.cpu.reg.SP; 
  game.mem.SetInAddr(0x100, PUSH_AF);
  game.cpu.reg.A = 0x01;
  game.cpu.reg.F = 0x02;
  game.cpu.execute_intruction(&game.mem);
...
TEST(Instructions, PUSH_DE_instruction) {
  ...
  game.initialize_registers();
  Address sp_old_position = game.cpu.reg.SP; 
  game.mem.SetInAddr(0x100, PUSH_DE);
  game.cpu.reg.D = 0x01;
  game.cpu.reg.E = 0x02;
  game.cpu.execute_intruction(&game.mem);
...
TEST(Instructions, PUSH_HL_instruction) {
  ...
  game.initialize_registers();
  Address sp_old_position = game.cpu.reg.SP; 
  game.mem.SetInAddr(0x100, PUSH_HL);
  game.cpu.reg.H = 0x01;
  game.cpu.reg.L = 0x02;
  game.cpu.execute_intruction(&game.mem);
...
TEST(Instructions, POP_HL_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, POP_HL);
...
TEST(Instructions, POP_BC_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, POP_BC);
  game.mem.SetInAddr(0x150, 0x20);
  game.mem.SetInAddr(0x151, 0xaa);
  game.cpu.reg.SP = 0x0150;
  game.cpu.reg.B = 0x00;
...
TEST(Instructions, POP_AF_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, POP_AF);
  game.mem.SetInAddr(0x150, 0x20);
  game.mem.SetInAddr(0x151, 0xaa);
  game.cpu.reg.SP = 0x0150;
  game.cpu.reg.A = 0x00;
...
TEST(Instructions, LD_aHL_d8_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_aHL_d8);
  game.mem.SetInAddr(0x101, 0x10);
...
TEST(Instructions, INC_A_instruction_flags) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, INC_A);
  game.mem.SetInAddr(0x101, INC_A);
...
TEST(Instructions, INC_B_instruction) {
  gameboy::Console game;
  game.initialize_registers();
...
TEST(Instructions, INC_B_instruction_flags) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, INC_B);
  game.mem.SetInAddr(0x101, INC_B);
...
TEST(Instructions, INC_C_instruction) {
  gameboy::Console game;
  game.initialize_registers();
...
TEST(Instructions, INC_D_instruction) {
  gameboy::Console game;
  game.initialize_registers();
...
TEST(Instructions, INC_E_instruction) {
  gameboy::Console game;
  game.initialize_registers();
...
TEST(Instructions, INC_H_instruction) {
  gameboy::Console game;
  game.initialize_registers();
...
TEST(Instructions, INC_L_instruction) {
  gameboy::Console game;
  game.initialize_registers();
...
TEST(Instructions, INC_aHL_instruction) {
  gameboy::Console game;
  game.initialize_registers();
...
TEST(Instructions, INC_aHL_instruction_flags) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, INC_aHL);
...
TEST(Instructions, DEC_A_instruction) {
  gameboy::Console game;
  game.initialize_registers();
...
TEST(Instructions, DEC_A_half_carry_set) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, DEC_A);
...
TEST(Instructions, DEC_B_instruction) {
  gameboy::Console game;
  game.initialize_registers();
...
TEST(Instructions, DEC_C_half_carry_set) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, DEC_C);
...
TEST(Instructions, LD_A_L_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_A_L);
  game.cpu.reg.A = 0x00;
  game.cpu.reg.L = 0x01;
...
TEST(Instructions, LD_D_A_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_D_A);
  game.cpu.reg.D = 0x00;
  game.cpu.reg.A = 0x01;
...
TEST(Instructions, LD_H_A_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_H_A);
  game.cpu.reg.A = 0x01;
  game.cpu.reg.H = 0x00;
...
TEST(Instructions, LD_L_A_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_L_A);
  game.cpu.reg.A = 0x01;
  game.cpu.reg.L = 0x00;
...
TEST(Instructions, LD_A_H_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_A_H);
  game.cpu.reg.A = 0x00;
  game.cpu.reg.H = 0x01;
...
TEST(Instructions, LD_B_A_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_B_A);
  game.cpu.reg.A = 0x20;
  game.cpu.reg.B = 0x00;
...
TEST(Instructions, LD_B_B_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_B_B);
  game.cpu.reg.B = 0x20;
...
TEST(Instructions, LD_B_C_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_B_C);
  game.cpu.reg.C = 0x20;
  game.cpu.reg.B = 0x00;
...
TEST(Instructions, LD_B_D_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_B_D);
  game.cpu.reg.B = 0x00;
  game.cpu.reg.D = 0x20;
...
TEST(Instructions, LD_B_E_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_B_E);
  game.cpu.reg.B = 0x00;
  game.cpu.reg.E = 0x20;
...
TEST(Instructions, LD_B_H_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_B_H);
  game.cpu.reg.B = 0x00;
  game.cpu.reg.H = 0x20;
...
TEST(Instructions, LD_B_L_instruction) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, LD_B_L);
  game.cpu.reg.B = 0x00;
  game.cpu.reg.L = 0x20;
...
TEST(Instructions, SUB_A_B_instruction) {
  gameboy::Console game;
  game.initialize_registers();
...
TEST(Instructions, SUB_A_B_instruction_zero_flag) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, SUB_A_B);
...
TEST(Instructions, SUB_A_B_instruction_carry_flag) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, SUB_A_B);
  game.mem.SetInAddr(0x101, SUB_A_B);
...
TEST(Instructions, AND_A_A_instruction) {
  gameboy::Console game;
  game.initialize_registers();
...
TEST(Instructions, AND_A_d8_instruction) {
  gameboy::Console game;
  game.initialize_registers();
...
TEST(Instructions, AND_A_d8_instruction_zero_flag) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, AND_A_d8);
...
TEST(Instructions, JR_Z_s8_instruction_nonzero) {
  gameboy::Console game;
  game.initialize_registers();
  game.mem.SetInAddr(0x100, JR_Z_s8);
  game.mem.SetInAddr(0x101, 0x8);
  game.cpu.reg.F = 0x0;
...
TEST(Instructions, CALL_NZ_a16_instruction_z_is_set) {
  ...
  game.cpu.reg.F = 0;
  utils::set_zero_flag(&game.cpu.reg.F, true);
  game.mem.SetInAddr(0x100, CALL_NZ_a16);
  game.mem.SetInAddr(0x101, 0x90);
  game.mem.SetInAddr(0x102, 0x02);
...
TEST(Instructions, CALL_C_a16_instruction_carry_is_not_set) {
  ...
  game.initialize_registers();
  game.cpu.reg.F = 0;
  game.mem.SetInAddr(0x100, CALL_C_a16);
  game.mem.SetInAddr(0x101, 0x90);
  game.mem.SetInAddr(0x102, 0x02);
...
TEST(Instructions, RET_NC_instruction_carry_is_set) {
  ...
  game.cpu.reg.F = 0;
  utils::set_carry_flag(&game.cpu.reg.F, true);
  game.mem.SetInAddr(0x100, RET_NC);
...
TEST(Instructions, RET_NC_instruction_carry_is_not_set) {
  ...
  game.mem.SetInAddr(0x101, 0x50);
  game.mem.SetInAddr(0x102, 0x01);
  game.mem.SetInAddr(0x150, RET_NC);
